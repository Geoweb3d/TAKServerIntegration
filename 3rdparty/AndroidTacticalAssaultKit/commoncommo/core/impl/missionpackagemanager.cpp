...
/*int vaa*/ MHD_Result MissionPackageManager::webThreadAccessHandlerCallbackRedir(void *cbContext,
...
/*int vaa*/ MHD_Result MissionPackageManager::webThreadAccessHandlerCallback(
                                          struct MHD_Connection *connection,
                                          const char *url,
                                          const char *method,
                                          const char *version,
                                          ...
                                          void **connectionContext)
{
    ...
    /*int vaa */ MHD_Result ret = MHD_queue_response(connection, code, response);
