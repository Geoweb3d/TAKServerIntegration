...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&course_) -
    reinterpret_cast<char*>(&speed_)) + sizeof(course_));
}
...
::PROTOBUF_NAMESPACE_ID::uint8* Track::_InternalSerialize(
  ...
  // double course = 2;
  if (!(this->_internal_course() <= 0 && this->_internal_course() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(class_specific_merge_from_start:atakmap.commoncommo.protobuf.v1.Track)
  ...
  if (!(from._internal_course() <= 0 && from._internal_course() >= 0)) {
