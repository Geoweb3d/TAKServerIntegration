...
class TakControl final :
 ...
 public:
  ...
  ~TakControl() override;
  explicit constexpr TakControl(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_contactuid();
...
void TakControl::set_contactuid(ArgT0&& arg0, ArgT... args) {
 ...
 contactuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TakControl::_internal_set_contactuid(const std::string& value) {
  ...
  contactuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TakControl::_internal_mutable_contactuid() {
  
  return contactuid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TakControl::release_contactuid() {
  ...
  return contactuid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
