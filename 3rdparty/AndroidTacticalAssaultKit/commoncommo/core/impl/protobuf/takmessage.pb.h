...
class TakMessage final :
 ...
 public:
  ...
  ~TakMessage() override;
  explicit constexpr TakMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::atakmap::commoncommo::protobuf::v1::TakControl* release_takcontrol();
  ...
  PROTOBUF_MUST_USE_RESULT ::atakmap::commoncommo::protobuf::v1::CotEvent* release_cotevent();
