...
private:
    ...
    static /*int* vaa */ MHD_Result webThreadAccessHandlerCallbackRedir(void *cls,
                                              ...
                                              void **con_cls);
    /*int vaa */ MHD_Result webThreadAccessHandlerCallback(struct MHD_Connection * connection,
                                              const char *url,
                                              const char *method,
                                              const char *version,
                                              const char *upload_data,
