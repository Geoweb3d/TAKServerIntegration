...
GEOWEB3DENGINE_API IGW3DActiveVectorData* CreateInstance( unsigned interface_version = GEOWEB3D_INTERFACE_VERSION );
GEOWEB3DENGINE_API void DestroyInstance( IGW3DActiveVectorData *p );
