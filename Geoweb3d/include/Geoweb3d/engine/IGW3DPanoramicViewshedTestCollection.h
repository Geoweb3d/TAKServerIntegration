...
namespace Geoweb3d
{
    extern "C++"
    {
        ...
        struct  GW3D_DLL IGW3DPanoramicViewshedTestCollection : public IGW3DCollection< IGW3DPanoramicViewshedTestWPtr >
        {
            virtual ~IGW3DPanoramicViewshedTestCollection() {}
