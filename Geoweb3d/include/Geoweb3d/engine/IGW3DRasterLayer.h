...
namespace Geoweb3d
{
	...
	struct  IG3DRasterServiceConfigVisitor
	{
	...
	struct IGW3DWebServiceConfiguration : public IG3DRasterServiceConfiguration
	{
	...
	struct IGW3DRasterLayer : public IGW3DLayer
	{
