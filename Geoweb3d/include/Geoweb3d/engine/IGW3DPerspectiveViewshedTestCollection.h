...
namespace Geoweb3d
{
    extern "C++"
    {
        ...
        struct  GW3D_DLL IGW3DPerspectiveViewshedTestCollection : public IGW3DCollection< IGW3DPerspectiveViewshedTestWPtr >
        {
            virtual ~IGW3DPerspectiveViewshedTestCollection() {}
            ...
            virtual IGW3DPerspectiveViewshedTestWPtr create() = 0;
            ...
            //SKIP-CODE-END
                ...
                ///
                /// 			To close a viewshed: IGW3DPerspectiveViewshedTestCollection::close( vtest );
                ///
                ///				IGW3DPerspectiveViewshedTestWPtr will become expired.</remarks>
                ///
                /// <param name="vtest"> the viewshed test</param>
                ////////////////////////////////////////////////////////////////////////////////////////////////////

            static void close(IGW3DPerspectiveViewshedTestWPtr vtest)
            {
                close_PerspectiveViewshedTest(vtest);
            }
        };
    }
}