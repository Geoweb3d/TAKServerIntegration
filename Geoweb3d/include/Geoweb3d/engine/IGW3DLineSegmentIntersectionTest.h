...
namespace Geoweb3d
{
    extern "C++"
    {
        ...
        {
            virtual  ~IGW3DLineSegmentIntersectionTest() {};
            ...
            //SKIP-CODE-BEGIN
                ...
                //struct  GW3D_DLL IGW3DAnalyisRepresentationDriversCollection()
                //{
                ...
                //struct  GW3D_DLL IGW3DAnalyisRepresentationCollection
                //{
                //	IGW3DCamera
